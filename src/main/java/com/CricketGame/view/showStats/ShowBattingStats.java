...
public class ShowBattingStats{
    public static String showStats(Player batsman) {
        ...
        if(batsmanStats.getBattingStatus().equals(PlayerStatusInBattingInning.OUT) && batsmanStats.getWicketStats().isPresent())
        ...
        else if(batsmanStats.getBattingStatus().equals(PlayerStatusInBattingInning.NOT_OUT))
