...
public class BatsmanStats implements Stats{
    ...
    private PlayerStatusInBattingInning battingStatus = PlayerStatusInBattingInning.NOT_BATTED_YET;
    ...
    public void updateStats(Runs runsTaken){
        this.battingStatus = PlayerStatusInBattingInning.NOT_OUT;
        this.ballTaken++;
        ...
        if(runsTaken.equals(Runs.WICKET)) {
            battingStatus = PlayerStatusInBattingInning.OUT;
        }
        else {
